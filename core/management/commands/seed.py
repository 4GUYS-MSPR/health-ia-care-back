...
from app.models import BodyPart, Category, Equipment, Gender, Level, Muscle, Subscription

from core.utils.logger import logger

from nutrition.models import Activity, Allergie, Category as FoodCategory, DietaryRestriction, DiseaseType, MealType, PreferredCuisine, Recommendation, Severity
...
class SeedFile:
    ...
    def __init__(self, model: type[models.Model], file: str):
        ...
        self.file = str(BASE_APP_DIR.parent.parent / 'enums' / file)
